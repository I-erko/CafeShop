...
export class AdminService {
  ...
  createProduct(product: ProductFormValues): any {
    return this.http.post(this.baseUrl + 'products', product);
  }

  updateProduct(product: ProductFormValues, id: number): any {
  ...
  uploadImage(file: File, id: number): any {
  ...
  deleteProductPhoto(photoId: number, productId: number): any {
    return this.http.delete(this.baseUrl + 'products/' + productId + '/photo/' + photoId);
  }

  setMainPhoto(photoId: number, productId: number): any {
